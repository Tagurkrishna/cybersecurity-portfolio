  ...
  return (
    <div className="relative p-6 space-y-10 max-w-5xl mx-auto text-gray-800 dark:text-white bg-gradient-to-br from-blue-100 to-purple-200 dark:from-gray-900 dark:to-black transition-all duration-500">
      ...
      <section>
        ...
        <p>
          I'm a passionate cybersecurity professional with hands-on experience in SOC tools, threat detection, SIEM, SOAR, and threat hunting.
          I build real-world security labs and automation workflows. Currently pivoting into the cybersecurity field with prior experience
          in data analytics and customer support roles.
        </p>
      </section>
      ...
      <section>
        ...
        <div className="flex flex-wrap gap-2">
          {[
            "SIEM (Splunk, Chronicle)", "SOAR (Shuffle, TheHive)", "MITRE ATT&CK",
            "Incident Response", "Threat Hunting", "Python", "Linux CLI",
            "SQL", "Suricata", "Network Security", "PowerShell"
          ].map(skill => (

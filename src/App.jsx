...
export default function Portfolio() {
  return (
    <div className="p-6 space-y-10 max-w-5xl mx-auto text-gray-800">
      <header className="text-center space-y-2">
        <h1 className="text-4xl font-bold text-blue-800">Tagur Krishna Nethipudi</h1>
        <p className="text-lg">Cybersecurity Analyst | Threat Hunter | SOC Automation</p>
